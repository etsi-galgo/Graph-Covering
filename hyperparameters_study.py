    ...
    for i in alpha_values:
        ...
        for j in gamma_values:
            ...
            for k in epsilon_values:
                ...
                # Cuidado que probamos todos los hiperparametros sobre el mismo grafo
                graph, q_table,cumulated_reward,segments_covered,coverage_distance = main("train", 0, 1, env_iter=200, g = graph, total_episodes=1000,  show = False, alpha = i,gamma=j,epsilon=k)
                graph, q_table,cumulated_reward,segments_covered,coverage_distance = main("test", 0, 1, env_iter=200, q_table=q_table, g = graph, total_episodes=1,  show = False, alpha = i,gamma=j)
